...
public class AfiliadoData {
    ...
    public AfiliadoData(String nombreAfiliado, String apellidoAfiliado, int dni, String domicilioAfiliado, String telefonoAfiliado, boolean estado) {
    ...
    public AfiliadoData(int idAfiliado, String nombreAfiliado, String apellidoAfiliado, int dni, String domicilioAfiliado, String telefonoAfiliado, boolean estado) {
    ...
    public String toString() {
        return "AfiliadoData{" + "idAfiliado=" + idAfiliado + ", nombreAfiliado=" + nombreAfiliado + ", apellidoAfiliado=" + apellidoAfiliado + ", dni=" + dni + ", domicilioAfiliado=" + domicilioAfiliado + ", telefonoAfiliado=" + telefonoAfiliado + ", estado=" + estado + '}';
    }
